...
function BusinessList({ businessList }) {
  ...
  return (
    ...
    <div className='flex overflow-scroll overflow-x-auto gap-4 scrollbar-hide scroll-smooth text-center'ref={elementRef}>
      {Array.isArray(businessList) && businessList.length > 0 ? (
        ...
        <div className='text-red-600 mx-auto'>No Healthcare available, choose a category to display results</div>
      )}
    </div>
    <svg xmlns="http://www.w3.org/2000/svg"
